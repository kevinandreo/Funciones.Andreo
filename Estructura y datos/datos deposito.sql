...
VALUES
		(31, 10, 1, 45, 15, 'total de 1059', 'llamar al 4769-8375', CURRENT_TIME()),
	(31, 9, 14, 2, 7, 'total de 995', 'llamar al 4769-8375', CURRENT_TIME()),
	(31, 31, 22, 3, 4, 'total de 979', 'llamar al 4769-8375', CURRENT_TIME())
;
...
VALUES
		(31, 1, 4, 23, 'Carlos Herrera', 'Cedula de identidad', 'Limpieza semanal', CURRENT_TIME(), 'Mantenimiento mensual'),
        (12, 1, 14, 77, 'Santiago', 'Documento de identidad', 'Limpieza semanal', CURRENT_TIME(), 'Mantenimento mensual'),
        (45, 1, 22, 55, 'Luis', 'Documento de identidad', 'Limpieza semanal', CURRENT_TIME(), 'Mantenimiento mensual'),
        (50, 1, 1, 12, 'Hernan', 'Documento de identidad', 'Limpieza semanal', CURRENT_TIME(), 'Mantenimiento mensual'),
